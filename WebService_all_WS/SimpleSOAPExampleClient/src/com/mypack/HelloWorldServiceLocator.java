...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.mypack.HelloWorldService {
    ...
    public com.mypack.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.mypack.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mypack.HelloWorldSoapBindingStub _stub = new com.mypack.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mypack.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mypack.HelloWorldSoapBindingStub _stub = new com.mypack.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://mypack.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://mypack.com", "HelloWorld"));
        }
